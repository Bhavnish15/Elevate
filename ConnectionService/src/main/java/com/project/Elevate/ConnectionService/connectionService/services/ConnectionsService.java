...
import com.project.Elevate.ConnectionService.connectionService.auth.AuthContextHolder;
...
public class ConnectionsService {
    ...
    public void sendConnectionRequest(Long receiverId) throws BadRequestException {
    ...
    public void acceptConnectionRequest(Long senderId) throws BadRequestException {
    ...
    public void rejectConnectionRequest(Long senderId) throws BadRequestException {
        Long receiverId = AuthContextHolder.getCurrentUserId();
